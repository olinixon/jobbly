...
function ResetPasswordForm() {
  ...
  if (!token) {
    return (
      <div className="text-center">
        <p className="text-sm text-[#DC2626] mb-4">Invalid or missing reset token.</p>
        <a href="/forgot-password" className="text-sm text-[#2563EB] dark:text-[#3B82F6] hover:underline">
  ...
  if (success) {
    return (
      <div className="text-center">
        <h2 className="text-lg font-semibold text-[#111827] dark:text-[#F1F5F9] mb-3">Password updated</h2>
        <p className="text-sm text-[#6B7280] dark:text-[#94A3B8] mb-6">
          Your password has been reset successfully.
        </p>
        <a href="/login" className="text-sm font-medium text-[#2563EB] dark:text-[#3B82F6] hover:underline">
  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          <label className="block text-sm font-medium text-[#374151] dark:text-[#CBD5E1] mb-1">New password</label>
        ...
        <div>
          <label className="block text-sm font-medium text-[#374151] dark:text-[#CBD5E1] mb-1">Confirm password</label>
          <input
            type={showPassword ? 'text' : 'password'}
            ...
            autoComplete="new-password"
            required
            className="w-full px-3 py-2 text-sm bg-white dark:bg-[#0F172A] border border-[#E5E7EB] dark:border-[#334155] rounded-lg text-[#111827] dark:text-[#F1F5F9] placeholder-[#9CA3AF] dark:placeholder-[#475569] focus:outline-none focus:ring-2 focus:ring-[#2563EB] transition"
          />
        </div>
    ...
    <div className="min-h-screen bg-[#F9FAFB] dark:bg-[#0F172A] flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white dark:bg-[#1E293B] rounded-xl border border-[#E5E7EB] dark:border-[#334155] shadow-sm p-8">
          <Suspense fallback={<p className="text-sm text-[#6B7280] dark:text-[#94A3B8]">Loading…</p>}>
            <ResetPasswordForm />
          </Suspense>
        </div>
      </div>
